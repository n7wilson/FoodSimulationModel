...
public class Person implements IAgent {
	...
	//The following two parameters are used to modify the percentage of agents who have a certain food preference
	//TODO: Implement this in a way that makes sense for Repast Java
	
	//which food preference is being focused on 
	public static String choice = "Meat";
	//percentage of Persons with the chosen food preference
	public static double percent = 0.25;
	...
	public void setPref() {
		...
		double interval = (1 - percent)/(preferences.length - 1);
	...
	public void buy(Person seller){
		...
		seller.food.remove(item);
			//must change the owner of the food before adding it to the buyer's food list
			item.owner = this;
		this.food.add(item);
	...
	public enum Status{
		NORMAL, HUNGRY, WORKING, DRIVING, SLEEPING, LOADING, MAINTAINING, HARVESTING, PLANTING
	}

	@Override
	public Coordinate getCoords() {
		// TODO Auto-generated method stub
		return ContextManager.getAgentGeometry(this).getCoordinate();
	}
	@Override
	...
	protected double distance(IAgent agent){
		Geometry here = ContextManager.getAgentGeometry(this);
		Geometry there = ContextManager.getAgentGeometry(agent);
